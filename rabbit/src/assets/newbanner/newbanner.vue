    ...
    <div class="xtx-goods-page">
      <div class="container">
        <div class="xtx-bread" data-v-b185dbf4="">
          ...
          <div class="xtx-bread-item" data-v-b185dbf4="">
            <a class="sxh" href="#/category/1010000" >{{$store.state.demo.bt2}}</a>
          </div>
          <i class="iconfont icon-angle-right"></i>
          <div class="xtx-bread-item" data-v-b185dbf4="">
            <a  class="sxh" href="#/category/sub/109303000" >{{$store.state.demo.bt1}}</a>
          </div>
          <i class="iconfont icon-angle-right"></i>
          <div class="xtx-bread-item" data-v-b185dbf4="">
          ...
          <div class="media" data-v-b185dbf4="">
            <div class="goods-image" data-v-d1fd3ff6="" data-v-b185dbf4="">
              ...
              <div class="middle" data-v-d1fd3ff6="">
                 <el-image class="imageItem" title="点击大图预览" :src="hgimg" fit="contain" />
                        <!-- 鼠标层罩 -->
                        ...
                        <div v-show="coverLayerShow" class="coverLayerRight">
                            <el-image :style="coverLayerImg" class="coverLayerRightImg" :src="hgimg" fit="contain" />
                        </div>
                <div
                  class="layer"
                  data-v-d1fd3ff6=""
              ...
              <ul class="small" data-v-d1fd3ff6=""> 
                ...
                >
                  <img :src="item" alt="" data-v-d1fd3ff6=""    v-for="(item, index) in arr.mainPictures"
                  :key="index"  :class="bl==index?'bv2':''"
          ...
          <div class="spec" data-v-b185dbf4="">
            ...
            <div class="xtx-numbox" data-v-3abe1060="" data-v-b185dbf4="">
              ...
              <div class="numbox" data-v-3abe1060="">
                ...
                ><input type="text" readonly="" data-v-3abe1060=""  v-model="val"  class="in1"/>
                <a
                  @click="add()"
                  href="javascript:;"
                  data-v-3abe1060=""
              ...
              <div class="goods-tabs" data-v-5dc77adc="" data-v-b185dbf4="">
                ...
                <div class="goods-detail" data-v-4d87a5c2="" data-v-5dc77adc="">
                  <ul class="attrs" data-v-4d87a5c2="">
                    <li data-v-4d87a5c2="" v-for="item,index in arr2.properties" :key="index">
                      <span class="dt" data-v-4d87a5c2="">{{item.name}}</span
                      ><span class="dd" data-v-4d87a5c2="">{{item.value}}</span>
                    </li>
                  </ul>
                     <img :src="item" alt="" v-for="item,index in arr2.pictures" :key="index" >
                </div>
              </div>
            </div>
...
import { cartSelect,cartSelectOne,} from '../../api/home'
import axios from "axios";
export default {
  components:{
    cartSelect,cartSelectOne,Delete
  },
  data() {
    return {
 ...
 enterImg(event){
        ...
        addCart(){
           // 木耳边领-姜黄  120cm   
            ...
            console.log(1);
            console.log(this.$store.state.demo. usercontent.token);
            var token = this.$store.state.demo. usercontent.token;
  ...
  mounted() {
    detail(this.$route.params.id).then((a) => {
      if (a.msg == "操作成功") {
        ...
        this.arr = a.result;
        this.arr1 = this.arr.specs[0].values;
