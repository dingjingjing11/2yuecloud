    ...
    <footer class="app-footer">
        <div class="contact">
            <div class="container">
                <dl>
                    <dt>客户服务</dt>
                    <dd><i class="iconfont icon-xiaoxi-xiaoxi"></i> 在线客服</dd>
                ...
                <dl>
                    <dt>下载APP</dt>
                    <dd class="qrcode"><img src="http://rabbit.mmsmd.top/img/qrcode.5372a064.jpg"></dd>
                    <dd class="download">扫描二维码<span>立马下载APP</span><a href="javascript:;">下载页面</a></dd>
                </dl>
                <dl>
                    <dt>服务热线</dt>
                    <dd class="hotline">400-0000-000 <small>周一至周日8:00-18:00</small></dd>
                </dl>
            </div>
        </div>
        <div class="extra">
            <div class="container">
                <div class="slogan"><a href="javascript:;"><i class="iconfont icon-box2xiangzi
"></i><span>价格亲民</span></a><a
                        href="javascript:;"><i class="iconfont icon-dianzanmw
"></i><span>物流快捷</span></a><a
                        href="javascript:;"><i class="iconfont icon-bangzhupeisongfuwu"></i><span>品质新鲜</span></a></div>
                <div class="copyright">
                    <p><a href="javascript:;">关于我们</a><a href="javascript:;">帮助中心</a><a href="javascript:;">售后服务</a><a
                            href="javascript:;">配送与验收</a><a href="javascript:;">商务合作</a><a
                            href="javascript:;">搜索推荐</a><a href="javascript:;">友情链接</a></p>
                    <p>CopyRight © 小兔鲜儿</p>
                </div>
            </div>
        </div>
